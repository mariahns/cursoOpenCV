...
if not cap.isOpened():
    ...
    exit()
#cap = cv2.VideoCapture('Video_Curso_004.mp4')
while(1):
    _, img = cap.read()
    ...
    yellow_lower = np.array([23,93,0],np.uint8)
    ...
    for pic, contour in enumerate(contours):
        ...
        if(area > 300):
            ...
            cv2.putText(img, "VERMELHO: ", (x, y), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255))    
    ...
    for pic, contour in enumerate(contours):
        ...
        if(area > 300):
            ...
            cv2.putText(img, "AMARELO: ", (x, y), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 255, 0))
    ...
    for pic, contour in enumerate(contours):
        ...
        if(area > 300):
            ...
            cv2.putText(img, "BRANCO: ", (x, y), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (255, 255, 255))
    ...
    for pic, contour in enumerate(contours):
        ...
        if(area > 300):
            ...
            cv2.putText(img, "PRETO: ", (x, y), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 0))
